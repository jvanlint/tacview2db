...
def main(argv):
	...
	parser.add_argument('-c', '--cleardb', action='store_true', help='Clear DB before importing file.')
	...
	logging.info(f'Begin processing file named {mission_filename}. Clear DB set to {clear_db}')
